...
async function registerCommands() {
    ...
    console.log(
        `📦 Pripravujem ${commandData.length} príkazov...`
    );
    ...
    console.log(
        "✅ Slash príkazy úspešne zaregistrované!"
    );
